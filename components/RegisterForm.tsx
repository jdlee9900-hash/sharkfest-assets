...
import { TERMS_TITLE, TERMS_INTRO, TERMS_CLAUSES, TERMS_WARNING } from '@/lib/terms'
      ...
      <div className="reg-card">
        ...
        <div className="reg-tc">
          ...
          <div className="reg-tc-body">
            <p className="reg-tc-lead"><strong>{TERMS_TITLE}</strong></p>
            ...
            {TERMS_CLAUSES.map((clause, i) => (
              <p key={`clause-${i}`}>{clause}</p>
            ))}

            <p className="reg-tc-warning"><strong>{TERMS_WARNING}</strong></p>
          </div>
        </div>
