...
import { getFolder, thumbUrl, fullUrl } from '@/lib/cloudinary'
      ...
      <main className="rc-gallery-wrap">
        ...
        {error && !noCredentials && (
          <div className="rc-notice rc-notice--error">
            ...
            <span>Could not load photos: {error}</span>
          </div>
        )}
        ...
        {images.length === 0 && !noCredentials && !error && (
          <div className="rc-notice rc-notice--info">
            No images found in the <code>run-club</code> folder. Check the folder name in Cloudinary.
          </div>
        )}
      </main>
